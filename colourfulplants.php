...
<?php
$query = 'SELECT * FROM `products` WHERE `title` IN ("Polka Dot Plant", "Prayer Plant" )';
                    ...
                    <aside class="left_widgets p_filter_widgets">
                        ...
                        <div class="widgets_inner">
                            <ul class="list">
                                ...
                                <li><a href="#">Low-Light Indoor Plants</a><span>(2)</span></li>
                                <li><a href="#">Air Purifying Indoor Plants</a><span>(3)</span></li>
                                <li><a href="#">Trailing Indoor Plants</a><span>(2)</span></li>
                                <li><a href="#">Small Indoor Plants</a><span>(6)</span></li>
                                <li><a href="#">Large Indoor Plants</a><span>(6)</span></li>
                                <li><a href="#">Succulents & Cacti</a><span>(3)</span></li>
                                <li><a href="#">Moisture Loving Indoor Plants</a><span>(2)</span></li>
                                <li><a href="#">Air Plants</a><span>(3)</span></li>
                            </ul>
                        </div>
                    </aside>
