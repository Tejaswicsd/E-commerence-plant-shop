...
<div class="col-md-8 form-group p_star">
  <input type="text" class="form-control" id="add1" name="add1"   placeholder="Address Line1" />
 
</div>
<div class="col-md-8 form-group p_star">
  <input type="text" class="form-control" id="add2" name="add2"  placeholder="Address Line1" />
...
<div style="text-align: center; margin-top: 20px;">
    <img src="img/qrcode.png" alt="QR Code" style="width: 150px; height: 150px;" />
    <p>Scan to Pay</p>
</div>
